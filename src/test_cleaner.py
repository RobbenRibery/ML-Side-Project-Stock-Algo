...
def text_pipline(text, forbidden_list): 
    ...
    t1_2 = remove_special_characters(t1)
    t1_3 = remove_numbers(t1_2)
    t1_4 = remove_punctuation(t1_3)
   
    t1_6 = get_lem(t1_4)
    t1_7 = remove_stopwords(t1_6) 
    t1_8 = remove_extra_whitespace_tabs(t1_7)
...
def list_generator(x,forbidden_list): 
    """
